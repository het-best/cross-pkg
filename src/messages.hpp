...
enum msg_type
{
    ...
    MSG_PKG_CURL_DOWN_FAIL = 306,
    MSG_PKG_HTTPS_DOWN_FAIL = 307,
    MSG_PKG_GIT_COMMIT = 308,
    MSG_PKG_DOWN_MIRROR = 309,
    MSG_PKG_DOWN_FAIL = 310,
    MSG_PKG_EXTR_SRC = 311,

    MSGV_PKG_CHECK_CACHE = 312,
    MSGV_PKG_START_DOWN = 313,
...
const std::array down_msgs =
{
    ...
    ERR_PREFIX + "Curl error while downloading source: {ARG1}\n",
    ERR_PREFIX + "HTTP error while downloading source: {ARG2}\n",
